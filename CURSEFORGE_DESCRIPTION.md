...
- **Party targets** — a small panel showing every group member and what they are attacking, with their role, their class colour and the raid marker sitting on their target. **Left-click a line to target that person, right-click to take what they are attacking** — both in combat. Drag it anywhere, drag the corner to widen it. Off until you switch it on with `/mh partytargets` or in Settings.
