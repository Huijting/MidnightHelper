...
### The Coiled Isle, mapped from the PTR (6 Aug 2026)

Rob flew a lap with `/mh vignettes` recording. 31 distinct vignettes, 26 of them on
map 2512, each with an npcID out of the objectGUID and coordinates from
`GetVignettePosition`. Classified by the atlas the client reported, not by us:
