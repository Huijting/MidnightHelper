...
History split out of `docs/NEXT_SESSION.md` on 2 Sep 2026, when it had grown to 4445 lines and only the top 226 were live.

⚠️ Nothing was deleted. Sections here that still read as open are listed by name at the bottom of the live file, so an open item cannot be lost by being old.
