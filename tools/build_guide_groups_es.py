#!/usr/bin/env python3
"""Generate SHARED_ES + GROUP_ES snippet for GuideGroups.lua."""
import re
import time
...
def translate_block(name: str, body: str) -> str:
    ...
    for k, v in pairs:
        ...
        if k == "GUIDE_GROUPS_MELEE_80_3":
            es = "Las profundidades son un paso más suave antes de buscar mazmorras en LFG."
...
snippet = translate_block("SHARED_ES", shared) + "\n\n" + translate_block("GROUP_ES", group) + "\n"
out = ROOT / "tools" / "_guide_groups_es_snippet.txt"
