...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	["DELVE_TIP_TWILIGHT_CRYPTS_ROUTE"] = "• Loosed Loa: usa el Evasive Elixir para explorar; mata a los Skeleton Charmers y los tótems — vigila a Mot'amra y no te cruces en su camino.|n• Party Crasher: escolta al Explorer, evita los cepos y abre los niveles con las palancas.|n• Trapped: salva a los rehenes y busca las palancas por el laberinto.",
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	["DELVE_TIP_TWILIGHT_CRYPTS_ROUTE"] = "• Loosed Loa: use o Evasive Elixir para explorar; mate os Skeleton Charmers e os totens — acompanhe Mot'amra e não cruze o caminho dele.|n• Party Crasher: escolte o Explorer, evite as armadilhas de urso, abra os andares com as alavancas.|n• Trapped: salve os reféns e ache as alavancas pelo labirinto.",
