...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	["DELVE_TIP_THE_DARKWAY_BOSS"] = "• Interrumpe a los Twilight Seekers.|n• Esquiva {SPELL:@abyssal_burst} (cono frontal).|n• {SPELL:@illusory_deceit}: ilusiones que explotan — mantén la distancia mientras te ocupas de Gulkat.",
	["DELVE_TIP_THE_DARKWAY_OVERVIEW"] = "• Norte de Lunargenta / Bosques de Canción Eterna (el Arcway).|n• Focusers Under Pressure, Leyline Technician y Ogre Powered (7 Unstable Aberrations).|n• Jefe final en todas las runs: Infiltrator Gulkat.",
