...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	["DELVE_TIP_THE_DARKWAY_BOSS"] = "• Unterbrich die Twilight Seekers.|n• Weich {SPELL:@abyssal_burst} aus (Frontalkegel).|n• {SPELL:@illusory_deceit}: explodierende Illusionen – halt Abstand, während du dich um Gulkat kümmerst.|n• Replicating Venomborne: Töte die Lesser Venomborne aus Serpentogenesis sofort – leben sie bei seinem nächsten Wirken noch, heilen sie ihn; verlass die Pfützen von Venom Splash (Schaden + Verlangsamung); Hydra Strike hinterlässt einen stapelnden DoT.",
	...
	["DELVE_TIP_GRUDGE_PIT_BOSS"] = "• Brightthorn: Tritt bei {SPELL:@solar_charge} zur Seite (hinterlässt Overbloom-Zonen); unterbrich {SPELL:@bloom_thorn}; dreh dich vor {SPELL:@blinding_burst} weg.|n• Gyrospore: Weich den {SPELL:@fungalstorm}-Zonen aus und burste dann während der 10 Sek. Benommenheit; geh bei {SPELL:@fungsplosion} zurück; tritt bei {SPELL:@fungal_charge} zur Seite.|n• Mycomight: Setz die Pfützen von {SPELL:@rancid_rain} abseits der Kampffläche ab; weich den Schockwellen von {SPELL:@fungis_fist} aus; tritt bei {SPELL:@fling_chair} zur Seite.|n• Replicating Venomborne: Töte die Lesser Venomborne aus Serpentogenesis sofort – leben sie bei seinem nächsten Wirken noch, heilen sie ihn; verlass die Pfützen von Venom Splash (Schaden + Verlangsamung); Hydra Strike hinterlässt einen stapelnden DoT.",
...
merge(ns._mhLocales and ns._mhLocales.frFR, {
	...
	["DELVE_TIP_THE_DARKWAY_BOSS"] = "• Interromps les Twilight Seekers.|n• Esquive {SPELL:@abyssal_burst} (cône frontal).|n• {SPELL:@illusory_deceit} : illusions explosives — garde tes distances pendant que tu gères Gulkat.|n• Replicating Venomborne : tue tout de suite les Lesser Venomborne de Serpentogenesis — encore en vie à son incantation suivante, ils le soignent ; sors des flaques de Venom Splash (dégâts + ralentissement) ; Hydra Strike laisse un DoT qui se cumule.",
	...
	["DELVE_TIP_GRUDGE_PIT_BOSS"] = "• Brightthorn : décale-toi de {SPELL:@solar_charge} (laisse des zones d'Overbloom) ; interromps {SPELL:@bloom_thorn} ; détourne-toi avant {SPELL:@blinding_burst}.|n• Gyrospore : esquive les zones de {SPELL:@fungalstorm}, puis burst pendant les 10 s d'étourdissement ; recule devant {SPELL:@fungsplosion} ; décale-toi de {SPELL:@fungal_charge}.|n• Mycomight : dépose les flaques de {SPELL:@rancid_rain} loin de la zone de combat ; esquive les ondes de choc de {SPELL:@fungis_fist} ; décale-toi de {SPELL:@fling_chair}.|n• Replicating Venomborne : tue tout de suite les Lesser Venomborne de Serpentogenesis — encore en vie à son incantation suivante, ils le soignent ; sors des flaques de Venom Splash (dégâts + ralentissement) ; Hydra Strike laisse un DoT qui se cumule.",
