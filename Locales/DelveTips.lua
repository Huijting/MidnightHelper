...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	["DELVE_TIP_THE_DARKWAY_BOSS"] = "• Interrompa os Twilight Seekers.|n• Desvie de {SPELL:@abyssal_burst} (cone frontal).|n• {SPELL:@illusory_deceit}: ilusões que explodem — mantenha distância enquanto cuida de Gulkat.",
	["DELVE_TIP_THE_DARKWAY_OVERVIEW"] = "• Norte de Luaprata / Floresta do Canto Eterno (o Arcway).|n• Focusers Under Pressure, Leyline Technician, Ogre Powered (7 Unstable Aberrations).|n• Chefe final em todas as runs: Infiltrator Gulkat.",
