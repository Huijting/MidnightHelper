...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	DGN_TIP_AA_ANCIENT_DPS = "Clear the dormant Lashers before full energy, or they all wake at once. Kill the thrown branch add and kick its cast.",
	DGN_TIP_AA_CRAWTH_DPS = "Stop casting when the ground erupts - it interrupts you anyway - then spread. Score in the fire goal: it stuns her and she takes 75% extra damage.",
	DGN_TIP_AA_DORAGOSA_DPS = "Walk your debuff away from the group; it bursts 8 yards wide. Every mechanic you eat stacks, and at 3 it becomes an Arcane Rift.",
	DGN_TIP_AA_VEXAMUS_DPS = "Soak the orbs one player each: every orb he absorbs blasts the whole group. Carry your own bolt out before it pools.",
	DGN_TIP_BV_IKUZZ_DPS = "Drop your roots at the edges. Fixated? Just run for the full 10 seconds - you cannot fight it off.",
	DGN_TIP_BV_RUIA_DPS = "Each form brings its own trick, so watch what she becomes. Hold your cooldowns for the endgame, when everything fires at once.",
	DGN_TIP_BV_TRINITY_DPS = "Follow the tank's target order, and stand in Kezkitt's beams - an unsoaked seed overgrows after 10 seconds.",
	DGN_TIP_BV_ZIEKKET_DPS = "Burst the Lightbloom orbs before they drift into Ziekket, and finish the Lashers properly - dormant ones wake back up.",
	DGN_TIP_DN_HOARDMONGER_DPS = "No adds and no switches: this is a stay-out-of-things fight. Never stand in the frontal, keep off the mushrooms.",
	DGN_TIP_DN_NALORAKK_DPS = "Bodies beat damage here: stand in the spirit bears' path to intercept them. Every bear that reaches Zul'jarra costs the group.",
	DGN_TIP_DN_SENTINEL_DPS = "Two burn checks: destroy the Fractured Shivercore the icicles reveal, and break the frozen veil fast - it ticks on the group until it drops.",
	DGN_TIP_MC_MUROJIN_DPS = "Both bosses have to die close together - watch the two health bars and swap early, because a lone survivor goes berserk.",
	DGN_TIP_MC_RAKTUL_DPS = "Kill the Soulbind Totems fast. During the soul phase, crowd-control and interrupt the big adds while everyone runs back to their body.",
	DGN_TIP_MC_VORDAZA_DPS = "The phantoms are your job: kill them before they reach anyone, but one at a time - every death is group damage nobody can dodge.",
	DGN_TIP_MR_KYSTIA_DPS = "Stun or crowd-control the clones - they all channel Felstorm. Switch to Nibbles when she turns to her light form.",
	DGN_TIP_MR_LITHIEL_DPS = "Spread 6+ yards, then clear the Wild Imps quickly. The Vilefiend has to be down before the next imp wave.",
	DGN_TIP_MR_XATHUUX_DPS = "Little to switch to here - take your bolt away from the group, then keep moving and keep your defensives for the group hits.",
	DGN_TIP_MR_ZAEN_DPS = "Line of sight is the whole fight: be behind a crate or pillar before the shot, not after it.",
	DGN_TIP_MT_ARCANOTRON_DPS = "Intercept the Energy Orbs during the refuel, and save your cooldowns for it: he takes +20% damage in that window.",
	DGN_TIP_MT_DEGENTRIUS_DPS = "Soak one Unstable Void Essence impact each, or it erupts. When your Entropy DoT is about to expire, walk out of the group first.",
	DGN_TIP_MT_GEMELLUS_DPS = "Linked to a copy? Run over and touch it - that breaks the link and strips his absorb shield. Damage into the shield is wasted.",
	DGN_TIP_MT_SERANEL_DPS = "Purge or spellsteal the Hastening Ward every time it lands. Step into the Suppression Zone for the wave, then get out - it silences you.",
	DGN_TIP_NX_KASRETH_DPS = "Clear your debuff by stepping into a leyline beam - the short stun costs less than keeping it. Otherwise never cross a leyline.",
	DGN_TIP_NX_LOTHRAXION_DPS = "When he hides among his images, find the real one and interrupt him - damage on the images is wasted.",
	DGN_TIP_NX_NYSARRA_DPS = "The Null Vanguard adds are the fight: anything still standing gets devoured, which heals her and bursts the group. Spread first, the strikes splash 14 yards.",
	DGN_TIP_PS_GARFROST_DPS = "Ore is cover: get behind a chunk for the forge pulse. Stay 5+ yards off the tank so the slam does not catch you too.",
	DGN_TIP_PS_KRICKICK_DPS = "When Krick teleports to a ritual circle, switch to the Shades. Fixated by Ick? Run wide - everyone else keeps hitting.",
	DGN_TIP_PS_TYRANNUS_DPS = "Marked? Stand near Bone Piles so they freeze; frozen piles cannot raise adds. When piles do rise, Plaguespreaders die first.",
	DGN_TIP_SR_ARAKNATH_DPS = "Block the construct beams with your body - every beam that lands heals him back up.",
	DGN_TIP_SR_RANJIT_DPS = "A positional fight, not a target one: step aside for the line, weave around the vortexes, and mind what is behind you when it blasts.",
	DGN_TIP_SR_RUKHRAN_DPS = "Quills mean a pillar, every time. Then kill the Sunwing quickly; whoever it fixates keeps their distance.",
	DGN_TIP_SR_VIRYX_DPS = "Kick the tank nuke every single time - it is a 3-second cast. Free anyone the Solar Zealot grabs before they go off the balcony.",
	DGN_TIP_ST_LURA_DPS = "Steer your beam through the Notes of Despair - they keep radiating until silenced - and angle it clear of allies, because it hits them too.",
	DGN_TIP_ST_NEZHAR_DPS = "Kill the tentacles and kick the tank nuke when you can. The zones tick hard, so get out fast rather than pushing for uptime.",
	DGN_TIP_ST_SAPRISH_DPS = "Kick Shadewing's cast, and drop your Void Bombs at the edges - the fewer bombs on the floor, the gentler the mass ignite.",
	DGN_TIP_ST_ZURAAL_DPS = "Clear the Coalesced Void adds before Crashing Void, or they get dragged in with you. Never stand in front of him.",
	DGN_TIP_VA_ATROXUS_DPS = "Kill the Toxic Creepers as they crawl out - the pools keep making more.",
	DGN_TIP_VA_CHARONUS_DPS = "Kite your own Gravitic Orb into an Unstable Singularity; inside 6 yards it dies. Pick safe ground before the knockback lands.",
	DGN_TIP_VA_TAZRAH_DPS = "After every teleport, burn the Ethereal Shades down before going back to the boss.",
	DGN_TIP_WS_DUO_DPS = "Split your damage so both die close together, and keep Shadow Bolt interrupted. Crowd-control the Dark Entity a curse spawns instead of chasing it down.",
	DGN_TIP_WS_EMBER_DPS = "Drop your fire puddles at the edges so the middle stays clean, and sidestep the breath rather than running out of range.",
	DGN_TIP_WS_HEART_DPS = "Take a windy arrow at 2-3 stacks, but leave one free for the full-energy blast.",
	DGN_TIP_WS_KROLUK_DPS = "Adds come at roughly two thirds and one third health: swap straight onto them, Phantasmal Mystic first, and keep it interrupted.",
})
...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	DGN_TIP_AA_ANCIENT_DPS = "Ruim de slapende Lashers op voor volle energie, anders worden ze allemaal tegelijk wakker. Dood de geworpen tak-add en kick zijn cast.",
	DGN_TIP_AA_CRAWTH_DPS = "Stop met casten als de grond openbarst - hij onderbreekt je toch - en spreid dan. Scoor in het vuurdoel: dat stunt haar en ze krijgt 75% extra schade.",
	DGN_TIP_AA_DORAGOSA_DPS = "Loop je debuff weg van de groep; hij barst 8 yards breed. Alles wat je eet stapelt, en bij 3 wordt het een Arcane Rift.",
	DGN_TIP_AA_VEXAMUS_DPS = "Soak de orbs, een per speler: elke orb die hij opneemt raakt de hele groep. Draag je eigen bolt weg voor hij een plas wordt.",
	DGN_TIP_BV_IKUZZ_DPS = "Laat je wortels aan de rand vallen. Gefixeerd? Gewoon 10 seconden rennen - vechten helpt niet.",
	DGN_TIP_BV_RUIA_DPS = "Elke vorm heeft zijn eigen truc, dus let op wat ze wordt. Bewaar je cooldowns voor de eindfase, als alles tegelijk afgaat.",
	DGN_TIP_BV_TRINITY_DPS = "Volg de doelvolgorde van je tank, en ga in Kezkitts stralen staan - een ongesoakt zaadje groeit na 10 seconden door.",
	DGN_TIP_BV_ZIEKKET_DPS = "Knal de Lightbloom-orbs kapot voor ze Ziekket bereiken, en maak de Lashers echt af - slapende worden weer wakker.",
	DGN_TIP_DN_HOARDMONGER_DPS = "Geen adds en geen wissels: dit is een blijf-overal-uit gevecht. Nooit voor de frontal staan, weg van de paddenstoelen.",
	DGN_TIP_DN_NALORAKK_DPS = "Lichamen tellen hier zwaarder dan schade: ga in het pad van de geestberen staan. Elke beer die Zul'jarra bereikt kost de groep.",
	DGN_TIP_DN_SENTINEL_DPS = "Twee burn-checks: sloop de Fractured Shivercore die de ijspegels blootleggen, en breek het bevroren schild snel - het tikt op de groep tot het valt.",
	DGN_TIP_MC_MUROJIN_DPS = "Beide bosses moeten bijna tegelijk sterven - kijk naar de twee balken en wissel op tijd, want een overlevende gaat berserk.",
	DGN_TIP_MC_RAKTUL_DPS = "Dood de Soulbind Totems snel. In de soul-fase: crowd-control en onderbreek de grote adds terwijl iedereen terugrent.",
	DGN_TIP_MC_VORDAZA_DPS = "De fantomen zijn jouw taak: dood ze voor ze iemand bereiken, maar een voor een - elke dood is groepsschade die niemand kan ontwijken.",
	DGN_TIP_MR_KYSTIA_DPS = "Stun of crowd-control de klonen - ze channelen allemaal Felstorm. Wissel naar Nibbles zodra ze haar lichtvorm aanneemt.",
	DGN_TIP_MR_LITHIEL_DPS = "Spreid 6+ yards en ruim de Wild Imps snel op. De Vilefiend moet dood zijn voor de volgende imp-golf.",
	DGN_TIP_MR_XATHUUX_DPS = "Weinig om naar te wisselen - neem je bolt weg van de groep, blijf bewegen en bewaar defensives voor de groepsklappen.",
	DGN_TIP_MR_ZAEN_DPS = "Line of sight is het hele gevecht: sta achter een krat of pilaar voor het schot, niet erna.",
	DGN_TIP_MT_ARCANOTRON_DPS = "Onderschep de Energy Orbs tijdens het bijtanken, en bewaar je cooldowns daarvoor: hij krijgt dan +20% schade.",
	DGN_TIP_MT_DEGENTRIUS_DPS = "Soak elk een Unstable Void Essence-inslag, anders barst hij open. Loopt je Entropy-DoT af? Eerst weg van de groep.",
	DGN_TIP_MT_GEMELLUS_DPS = "Verbonden met een kopie? Ren erheen en raak hem aan - dat breekt de link en haalt zijn absorb-schild weg. Schade in dat schild is verspild.",
	DGN_TIP_MT_SERANEL_DPS = "Purge of spellsteal de Hastening Ward elke keer. Stap in de Suppression Zone voor de wave en dan eruit - hij silencet je.",
	DGN_TIP_NX_KASRETH_DPS = "Haal je debuff eraf in een leyline-straal - die korte stun kost minder dan de debuff. Kruis de leylines verder nooit.",
	DGN_TIP_NX_LOTHRAXION_DPS = "Verstopt hij zich tussen zijn beelden? Zoek de echte en onderbreek hem - schade op de beelden is verspild.",
	DGN_TIP_NX_NYSARRA_DPS = "De Null Vanguard-adds zijn het gevecht: wat nog leeft wordt opgeslokt, wat haar healt en de groep raakt. Spreid eerst, de klappen splashen 14 yards.",
	DGN_TIP_PS_GARFROST_DPS = "Erts is dekking: ga achter een brok staan bij de forge-puls. Blijf 5+ yards van de tank zodat de slam jou niet meepakt.",
	DGN_TIP_PS_KRICKICK_DPS = "Teleporteert Krick naar een ritueelcirkel? Wissel naar de Shades. Gefixeerd door Ick: ren wijd, de rest blijft slaan.",
	DGN_TIP_PS_TYRANNUS_DPS = "Gemarkeerd? Ga bij Bone Piles staan zodat ze bevriezen; bevroren stapels kunnen geen adds oproepen. Komen ze toch: Plaguespreaders eerst.",
	DGN_TIP_SR_ARAKNATH_DPS = "Blokkeer de stralen van de constructs met je lichaam - elke straal die aankomt healt hem weer op.",
	DGN_TIP_SR_RANJIT_DPS = "Een positioneel gevecht, geen doelwit-gevecht: opzij voor de lijn, om de vortexen heen, en let op wat er achter je staat.",
	DGN_TIP_SR_RUKHRAN_DPS = "Quills betekent pilaar, elke keer. Dood daarna de Sunwing snel; wie hij fixeert houdt afstand.",
	DGN_TIP_SR_VIRYX_DPS = "Kick de tank-nuke elke keer - het is een cast van 3 seconden. Bevrijd wie de Solar Zealot grijpt voor ze van het balkon gaan.",
	DGN_TIP_ST_LURA_DPS = "Stuur je straal door de Notes of Despair - die blijven stralen tot ze gedempt zijn - en houd hem weg van je maten, want hij raakt hen ook.",
	DGN_TIP_ST_NEZHAR_DPS = "Dood de tentakels en kick de tank-nuke als het kan. De zones tikken hard, dus eruit in plaats van uptime pakken.",
	DGN_TIP_ST_SAPRISH_DPS = "Kick Shadewings cast, en laat je Void Bombs aan de rand vallen - hoe minder bommen, hoe milder de massa-ontsteking.",
	DGN_TIP_ST_ZURAAL_DPS = "Ruim de Coalesced Void-adds op voor Crashing Void, anders worden ze mee naar binnen getrokken. Nooit voor hem staan.",
	DGN_TIP_VA_ATROXUS_DPS = "Dood de Toxic Creepers zodra ze uit de plassen kruipen - er komen er steeds meer.",
	DGN_TIP_VA_CHARONUS_DPS = "Sleep je eigen Gravitic Orb naar een Unstable Singularity; binnen 6 yards gaat hij kapot. Kies veilige grond voor de knockback.",
	DGN_TIP_VA_TAZRAH_DPS = "Na elke teleport: brand de Ethereal Shades weg voor je terug naar de boss gaat.",
	DGN_TIP_WS_DUO_DPS = "Verdeel je schade zodat ze bijna tegelijk sterven, en houd Shadow Bolt onderbroken. De Dark Entity uit een curse: crowd-controlen, niet achterna jagen.",
	DGN_TIP_WS_EMBER_DPS = "Laat je vuurplassen aan de rand vallen zodat het midden schoon blijft, en stap opzij voor de breath in plaats van weg te rennen.",
	DGN_TIP_WS_HEART_DPS = "Pak een windpijl bij 2-3 stacks, maar houd er een vrij voor de grote klap op volle energie.",
	DGN_TIP_WS_KROLUK_DPS = "Adds komen rond twee derde en een derde health: meteen erop, Phantasmal Mystic eerst, en blijf hem onderbreken.",
})
