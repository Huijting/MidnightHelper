...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	DGN_TIP_BV_TRINITY_DPS = "DPS: Blijf op het doelwit van je tank in plaats van je schade over alle drie te verdelen. Een beam soaken kost uptime en is het toch waard.",
