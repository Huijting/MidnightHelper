...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	RAID_BOSS_NYMRISSA_STEPS = "• |cffffd100The way in is UNDERWATER|r — a submerged cave, so your breath bar starts running before the fight does.|n• The first Lair: one boss in an underwater grotto, instanced, and it feeds the Raid row of your Great Vault.|n• Six abilities are known by name from the 12.1 PTR, but not what each one does — read this as a heads-up list, not a strategy.|n• Adds — {SPELL:1257717} brings murlocs; killing them is the call.|n• An orb to get away from — {SPELL:1313393}.|n• Mind where you stand — {SPELL:1258668}.|n• Damage on the whole group — {SPELL:1260837}.|n• Aimed at the tank as a line — {SPELL:1282937}, or {SPELL:1268562} on Mythic.|n• Soft enrage at 10 minutes.|n• The lair opens 18 Aug; the real steps land after the first live run.",
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	RAID_BOSS_NYMRISSA_STEPS = "• |cffffd100Der Eingang liegt UNTER WASSER|r — eine versunkene Höhle, deine Atemleiste läuft also schon vor dem Kampf.|n• Der erste Lair: ein Boss in einer Unterwassergrotte, instanziiert, und er zählt für die Schlachtzugsreihe deiner Great Vault.|n• Sechs Fähigkeiten kennen wir vom 12.1-PTR namentlich, aber nicht, was sie tun — lies das als Vorwarnung, nicht als Taktik.|n• Adds — {SPELL:1257717} bringt Murlocs; die umzuhauen ist die Ansage.|n• Eine Kugel, von der du weggehst — {SPELL:1313393}.|n• Achte darauf, wo du stehst — {SPELL:1258668}.|n• Schaden auf die ganze Gruppe — {SPELL:1260837}.|n• Als Linie auf den Tank — {SPELL:1282937}, auf Mythisch {SPELL:1268562}.|n• Soft-Enrage nach 10 Minuten.|n• Der Lair öffnet am 18. Aug; die echten Schritte folgen nach dem ersten Live-Run.",
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	RAID_BOSS_NYMRISSA_STEPS = "• |cffffd100A entrada fica DEBAIXO D’ÁGUA|r — uma caverna submersa, então sua barra de fôlego corre antes mesmo da luta.|n• O primeiro Lair: um chefe numa gruta submersa, em instância, e conta para a linha de Raide da sua Great Vault.|n• Seis habilidades são conhecidas pelo nome desde o PTR 12.1, mas não o que cada uma faz — leia como um aviso, não como tática.|n• Adds — {SPELL:1257717} traz murlocs; matá-los é o chamado.|n• Um orbe do qual se afastar — {SPELL:1313393}.|n• Cuidado com onde você está — {SPELL:1258668}.|n• Dano no grupo inteiro — {SPELL:1260837}.|n• Em linha no tank — {SPELL:1282937}, ou {SPELL:1268562} no Mítico.|n• Enrage leve aos 10 minutos.|n• O lair abre em 18 de ago; os passos de verdade chegam após a primeira run ao vivo.",
