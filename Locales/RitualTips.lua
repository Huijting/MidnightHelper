...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• One boss with an energy bar. When it fills he casts {SPELL:1221637} — a knockback, so mind where the edge is.|n• Kill the adds from {SPELL:1221622} quickly; he feeds on them.|n• {SPELL:1221787} is the raid-damage window.|n• Get out of {SPELL:1222088} when a pool lands on you.|n• Tanks: {SPELL:1221781} is the big hit — defensive, and swap on it.",
	RAID_BOSS_ROTMIRE_TANK = "• {SPELL:1221781} stacks — swap with the off-tank, and keep the boss out of the spore/vine mess.",
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} is the raid-damage spike; {SPELL:1221781} hits the tank hard.",
	...
	RITUAL_BOSS_MINDBREAKER_STEPS = "• Empowered Mindbreaker — Daggerspine Point stage 2 'Beast From the Deep': a deep creature Lady Selen'vjar supercharges with stolen void magic.|n• For now: interrupt its casts and step out of obvious ground effects.|n• That is honestly all we have. Its abilities were never datamined and nobody has reported a run. If you fight it, tell us what it did on Discord and it goes in.",
...
merge(ns._mhLocales and ns._mhLocales.itIT, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• Un solo boss con una barra di energia. Quando si riempie lancia {SPELL:1221637} — un knockback, occhio al bordo.|n• Uccidete in fretta gli add di {SPELL:1221622}; se ne nutre.|n• {SPELL:1221787} è la finestra di danno al raid.|n• Esci da {SPELL:1222088} quando la pozza ti tocca.|n• Tank: {SPELL:1221781} è il colpo grosso — difensiva, e scambiatevi.",
	...
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} è il picco di danno al raid; {SPELL:1221781} colpisce forte il tank.",
...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• Eén boss met een energiebalk. Vult die, dan komt {SPELL:1221637} — een knockback, dus let op waar de rand is.|n• Maak de adds van {SPELL:1221622} snel dood; daar teert hij op.|n• {SPELL:1221787} is het raid-damage-venster.|n• Stap uit {SPELL:1222088} zodra de plas op jou landt.|n• Tanks: {SPELL:1221781} is de harde klap — defensive, en wissel erop.",
	RAID_BOSS_ROTMIRE_TANK = "• {SPELL:1221781} stapelt — wissel met de off-tank en houd de boss uit de sporen/vines-rommel.",
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} is de raid-damage-piek; {SPELL:1221781} raakt de tank hard.",
	...
	RITUAL_BOSS_MINDBREAKER_STEPS = "• Empowered Mindbreaker — Daggerspine Point stage 2 'Beast From the Deep': een diepzee-wezen dat Lady Selen'vjar oplaadt met gestolen void-magie.|n• Voorlopig: interrupt z'n casts en stap uit zichtbare grond-effecten.|n• Eerlijk gezegd is dat alles wat we hebben. Z'n abilities zijn nooit gedataminet en niemand heeft een run doorgegeven. Vecht je hem, vertel dan op Discord wat hij deed — dan komt het erin.",
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• Ein Boss mit einer Energieleiste. Ist sie voll, wirkt er {SPELL:1221637} — ein Knockback, achte auf die Kante.|n• Tötet die Adds von {SPELL:1221622} schnell; davon nährt er sich.|n• {SPELL:1221787} ist das Raidschadensfenster.|n• Geh aus {SPELL:1222088} heraus, wenn die Pfütze auf dir landet.|n• Tanks: {SPELL:1221781} ist der harte Schlag — Defensive, und wechselt darauf.",
	...
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} ist die Raidschadensspitze; {SPELL:1221781} trifft den Tank hart.",
	...
	RITUAL_BOSS_MINDBREAKER_STEPS = "• Empowered Mindbreaker — Daggerspine Point Phase 2 'Beast From the Deep': eine Tiefsee-Kreatur, die Lady Selen'vjar mit gestohlener Void-Magie auflädt.|n• Vorerst: unterbrecht seine Zauber und tretet aus offensichtlichen Bodeneffekten.|n• Ehrlich gesagt ist das alles, was wir haben. Seine Fähigkeiten wurden nie datamined und niemand hat einen Run gemeldet. Kämpfst du gegen ihn, erzähl uns auf Discord, was er gemacht hat — dann kommt es rein.",
...
merge(ns._mhLocales and ns._mhLocales.frFR, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• Un seul boss avec une barre d'énergie. Pleine, il lance {SPELL:1221637} — un knockback, attention au bord.|n• Tuez vite les adds de {SPELL:1221622} ; il s'en nourrit.|n• {SPELL:1221787} est la fenêtre de dégâts sur le raid.|n• Sors de {SPELL:1222088} quand la flaque tombe sur toi.|n• Tanks : {SPELL:1221781} est le gros coup — défensive, et échangez dessus.",
	...
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} est le pic de dégâts sur le raid ; {SPELL:1221781} frappe fort le tank.",
	...
	RITUAL_BOSS_MINDBREAKER_STEPS = "• Empowered Mindbreaker — Daggerspine Point phase 2 'Beast From the Deep' : une créature des profondeurs que Lady Selen'vjar surcharge de magie du Vide volée.|n• Pour l'instant : interrompez ses incantations et sortez des effets au sol évidents.|n• Honnêtement, c'est tout ce que nous avons. Ses capacités n'ont jamais été datamined et personne n'a signalé de run. Si tu l'affrontes, raconte-nous sur Discord ce qu'il a fait et ce sera ajouté.",
...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• Un solo jefe con barra de energía. Al llenarse lanza {SPELL:1221637} — un empujón, cuidado con el borde.|n• Matad rápido los adds de {SPELL:1221622}; se alimenta de ellos.|n• {SPELL:1221787} es la ventana de daño al raid.|n• Sal de {SPELL:1222088} cuando el charco caiga sobre ti.|n• Tanques: {SPELL:1221781} es el golpe fuerte — defensiva, y cambiad en él.",
	...
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} es el pico de daño al raid; {SPELL:1221781} golpea fuerte al tanque.",
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	RAID_BOSS_ROTMIRE_STEPS = "• Um só chefe, com barra de energia. Cheia, ele lança {SPELL:1221637} — um empurrão, cuidado com a borda.|n• Matem rápido os adds de {SPELL:1221622}; ele se alimenta deles.|n• {SPELL:1221787} é a janela de dano no raide.|n• Saia de {SPELL:1222088} quando a poça cair em você.|n• Tanques: {SPELL:1221781} é o golpe pesado — defensiva, e troquem nele.",
	RAID_BOSS_ROTMIRE_TANK = "• {SPELL:1221781} acumula — alterne com o off-tank e mantenha o boss fora da bagunça de esporos/vinhas.",
	RAID_BOSS_ROTMIRE_HEALER = "• {SPELL:1221787} é o pico de dano no raide; {SPELL:1221781} bate forte no tanque.",
	...
	RITUAL_BOSS_MINDBREAKER_STEPS = "• Empowered Mindbreaker — Daggerspine Point fase 2 'Beast From the Deep': uma criatura das profundezas que Lady Selen'vjar sobrecarrega com magia do Vazio roubada.|n• Por enquanto: interrompa as conjurações dele e saia de efeitos de chão óbvios.|n• Sinceramente, é tudo o que temos. As habilidades dele nunca foram datamined e ninguém reportou uma run. Se você enfrentá-lo, conte no Discord o que ele fez e entra aqui.",
