...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	-- Intro / how it works ---------------------------------------------------
	RITUAL_TIP_INTRO_TIERS = "• Pick your tier at the Curious Obelisk; clear each tier to unlock the next.|n• The obelisk names what each tier asks for: Tier 3 needs 1 challenge active, Tier 4 needs 2, Tier 5 needs 4, Tier 6 needs 6.|n• Higher tiers give more Spoils and renown. |cffffffffHover a tier in the dropdown|r and it tells you the item level it is meant for — Tier 6 says 275. Read it there rather than from a list, because Season 2 moved those numbers and any list printed here goes stale. Higher tiers give more Spoils and renown.",
...
merge(ns._mhLocales and ns._mhLocales.itIT, {
	...
	-- Intro / come funziona --------------------------------------------------
	RITUAL_TIP_INTRO_TIERS = "• Scegli il tuo tier alla Curious Obelisk; completa ogni tier per sbloccare il successivo.|n• L'obelisco dice cosa chiede ogni tier: il Tier 3 richiede 1 challenge attiva, il Tier 4 ne richiede 2, il Tier 5 ne richiede 4, il Tier 6 ne richiede 6.|n• I tier più alti danno più Spoils e renown. |cffffffffPassa il mouse su un tier nel menu|r e ti dice per quale item level è pensato — il Tier 6 dice 275. Leggilo lì invece che da un elenco: la Season 2 ha spostato quei numeri e tutto ciò che stampiamo qui invecchia.",
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	RITUAL_TIP_INTRO_TIERS = "• Wähle deine Stufe am Curious Obelisk; schließe jede Stufe ab, um die nächste freizuschalten.|n• Der Obelisk nennt, was jede Stufe verlangt: Tier 3 braucht 1 aktive Challenge, Tier 4 braucht 2, Tier 5 braucht 4, Tier 6 braucht 6.|n• Höhere Stufen geben mehr Spoils und Ansehen. |cffffffffFahr im Dropdown über eine Stufe|r und sie nennt die Gegenstandsstufe, für die sie gedacht ist — Tier 6 sagt 275. Lies sie dort statt aus einer Liste: Season 2 hat diese Zahlen verschoben, und alles, was wir hier abdrucken, veraltet.",
...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	-- Intro / cómo funciona ----------------------------------------------------------
	RITUAL_TIP_INTRO_TIERS = "• Elige tu tier en el Curious Obelisk; cada tier debe completarse para desbloquear el siguiente.|n• El obelisco dice qué pide cada tier: el Tier 3 requiere 1 challenge activo, el Tier 4 requiere 2, el Tier 5 requiere 4, el Tier 6 requiere 6.|n• Los tiers más altos dan más Spoils y renombre. |cffffffffPasa el ratón por un tier en el desplegable|r y te dice para qué nivel de objeto está pensado — el Tier 6 dice 275. Léelo ahí en vez de en una lista: la Season 2 movió esos números y todo lo que imprimamos aquí envejece.",
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	-- Intro / como funciona --------------------------------------------------------------
	RITUAL_TIP_INTRO_TIERS = "• Escolhe o teu tier no Curious Obelisk; cada tier precisa ser limpo para desbloquear o próximo.|n• O obelisco diz o que cada tier pede: o Tier 3 exige 1 challenge ativo, o Tier 4 exige 2, o Tier 5 exige 4, o Tier 6 exige 6.|n• Tiers mais altos dão mais Spoils e renome. |cffffffffPassa o rato por um tier no menu|r e ele diz para que item level foi pensado — o Tier 6 diz 275. Lê-o aí em vez de numa lista: a Season 2 mudou esses números e tudo o que imprimimos aqui envelhece.",
