...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Every add that reaches him costs the raid heavy damage plus a DoT.|n• Phase 2 is constant raid-wide damage — pace your cooldowns across the whole phase.",
	RAID_BOSS_NEKZALI_DPS = "• Break the {SPELL:1297630} shields with magic damage, then kill them.|n• Kill the Echoes of Jawae to end the intermission.|n• Open phase 2 with cooldowns — he has to die before he reaches 100 energy.",
	...
	RAID_BOSS_LOSTEXPLORERS_STEPS = "• Interrupt {SPELL:1286921}.|n• The floor is the fight: dodge {SPELL:1291759}, {SPELL:1291933} and {SPELL:1292104}.|n• {SPELL:1290711}: our two sources disagree — run out or stack up — so follow your leader’s call.|n• Feed Disgusting Fish to possessed Tortollans to break the possession.|n• Mor'zahi: interrupt Final Ascension whenever you can — since the 10 Sep hotfix that resets his rising damage.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• An add that reaches the centre is heavy raid-wide DoT damage.|n• At the Fire fountain the Burning Venoms pulse damage on everyone.",
	RAID_BOSS_VASHNIK_DPS = "• Every add dies before it reaches the centre — that is the whole job.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In makes him take 30% more damage — that is the burn window.",
	...
	RAID_BOSS_ULATEK_TANK = "Stay in melee range throughout — one tank holds the tail, the other the boss itself.",
	RAID_BOSS_ULATEK_HEALER = "• The soaking is what costs the healing — plan your cooldowns around the soak groups.|n• {SPELL:1301118} leaves a DoT on the players it links.",
	RAID_BOSS_ULATEK_DPS = "• Heroism on the first Venomous Heart.|n• In phase 3 melee stay on the boss platform, and the Blightscale adds go down fast.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Swap at 8-10 stacks of Blackening Wounds — every stack cuts the active tank's maximum health.",
	RAID_BOSS_AVERZIAN_DPS = "• Kill the Abyssal Voidshapers so three never survive in a straight row — a finished cast claims that square.|n• Then the Shadowguard Stalwarts, then the Voidbound Annihilators.",
	...
	RAID_BOSS_VORASIUS_TANK = "Soak the first two {SPELL:1241836}, then let the debuff fall off — the off-tank takes the odd circles for the rest of the cycle.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Park him by a marked gate and kite away from each orb until it dies. During {SPELL:1246175} he cannot be moved at all.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} is heavy raid damage from start to finish.|n• The other spike is the second orb dying while Dark Radiation is still on the raid — ask your damage to hold it.",
...
merge(ns._mhLocales and ns._mhLocales.itIT, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Ogni add che lo raggiunge costa al raid danno pesante più un DoT.|n• La fase 2 è danno costante su tutto il raid — distribuisci i cooldown per l'intera fase.",
	RAID_BOSS_NEKZALI_DPS = "• Rompi gli scudi di {SPELL:1297630} con danno magico, poi uccidili.|n• Uccidi gli Echoes of Jawae per chiudere l'intermezzo.|n• Apri la fase 2 con i cooldown — deve morire prima di arrivare a 100 di energia.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• Un add che raggiunge il centro significa pesante danno DoT su tutto il raid.|n• Alla fontana del Fuoco i Burning Venom pulsano danno su tutti.",
	RAID_BOSS_VASHNIK_DPS = "• Ogni add muore prima di raggiungere il centro — è tutto il lavoro.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In gli fa subire il 30% di danni in più — quella è la finestra di burst.",
	...
	RAID_BOSS_ULATEK_TANK = "Resta sempre a distanza di mischia — un tank tiene la coda, l'altro il boss.",
	RAID_BOSS_ULATEK_HEALER = "• È il soak a costare le cure — pianifica i cooldown attorno ai gruppi di soak.|n• {SPELL:1301118} lascia un DoT sui giocatori che collega.",
	RAID_BOSS_ULATEK_DPS = "• Heroism sul primo Venomous Heart.|n• In fase 3 i melee restano sulla piattaforma del boss e gli add Blightscale muoiono in fretta.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Scambiate a 8-10 stack di Blackening Wounds — ogni stack riduce la salute massima del tank attivo.",
	RAID_BOSS_AVERZIAN_DPS = "• Uccidi gli Abyssal Voidshaper in modo che non ne sopravvivano mai tre in fila — un cast completato conquista quella casella.|n• Poi gli Shadowguard Stalwart, poi i Voidbound Annihilator.",
	...
	RAID_BOSS_VORASIUS_TANK = "Assorbi i primi due {SPELL:1241836}, poi lascia scadere il debuff — l'off-tank prende i cerchi dispari per il resto del ciclo.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Piazzalo vicino a un cancello marcato e allontanalo da ogni orbe finché non muore. Durante {SPELL:1246175} non può essere spostato.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} è danno pesante al raid dall'inizio alla fine.|n• L'altro picco è il secondo orbe che muore mentre Dark Radiation è ancora sul raid — chiedi ai dps di trattenerlo.",
...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Elke add die hem bereikt kost de raid zware schade plus een DoT.|n• Fase 2 is constante raid-schade — verdeel je cooldowns over de hele fase.",
	RAID_BOSS_NEKZALI_DPS = "• Breek de schilden van {SPELL:1297630} met magic damage en maak ze daarna dood.|n• Dood de Echoes of Jawae om de intermission te beëindigen.|n• Open fase 2 met cooldowns — hij moet dood zijn vóór hij 100 energie haalt.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• Een add die het midden bereikt betekent zware DoT-schade op de hele raid.|n• Bij de Fire-fontein pulsen de Burning Venoms schade op iedereen.",
	RAID_BOSS_VASHNIK_DPS = "• Elke add gaat dood vóór hij het midden bereikt — dat is de hele opdracht.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In laat hem 30% meer schade nemen — dat is je burn-venster.",
	...
	RAID_BOSS_ULATEK_TANK = "Blijf de hele fight op melee-afstand — de ene tank houdt de staart, de andere de boss zelf.",
	RAID_BOSS_ULATEK_HEALER = "• Het soaken is wat de healing kost — plan je cooldowns rond de soak-groepen.|n• {SPELL:1301118} laat een DoT achter op de spelers die hij verbindt.",
	RAID_BOSS_ULATEK_DPS = "• Heroism op de eerste Venomous Heart.|n• In fase 3 blijven de melee op het boss-platform en gaan de Blightscale-adds snel neer.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Wissel op 8-10 stacks Blackening Wounds — elke stack verlaagt het maximale leven van de actieve tank.",
	RAID_BOSS_AVERZIAN_DPS = "• Dood de Abyssal Voidshapers zo dat er nooit drie op een rij overleven — een afgemaakte cast claimt dat vak.|n• Daarna de Shadowguard Stalwarts, daarna de Voidbound Annihilators.",
	...
	RAID_BOSS_VORASIUS_TANK = "Soak de eerste twee {SPELL:1241836} en laat de debuff daarna aflopen — de off-tank neemt de oneven cirkels voor de rest van de cyclus.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Zet hem bij een gemarkeerde poort en kite weg van elke orb tot die dood is. Tijdens {SPELL:1246175} is hij niet te verplaatsen.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} is zware raid-schade van begin tot eind.|n• De andere piek is de tweede orb die sterft terwijl Dark Radiation nog op de raid staat — laat je damage die vasthouden.",
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Jeder Add, der ihn erreicht, kostet den Raid schweren Schaden plus einen DoT.|n• Phase 2 ist durchgehender Raidschaden — teil deine Cooldowns über die ganze Phase ein.",
	RAID_BOSS_NEKZALI_DPS = "• Brich die Schilde von {SPELL:1297630} mit magischem Schaden und töte sie dann.|n• Tötet die Echoes of Jawae, um das Zwischenspiel zu beenden.|n• Eröffnet Phase 2 mit Cooldowns — er muss fallen, bevor er 100 Energie erreicht.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• Ein Add, das die Mitte erreicht, bedeutet schweren DoT-Schaden auf dem ganzen Raid.|n• An der Feuerfontäne pulsen die Burning Venoms Schaden auf alle.",
	RAID_BOSS_VASHNIK_DPS = "• Jeder Add stirbt, bevor er die Mitte erreicht — das ist die ganze Aufgabe.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In lässt ihn 30% mehr Schaden nehmen — das ist das Burn-Fenster.",
	...
	RAID_BOSS_ULATEK_TANK = "Bleibt durchgehend in Nahkampfreichweite — ein Tank hält den Schwanz, der andere den Boss selbst.",
	RAID_BOSS_ULATEK_HEALER = "• Das Soaken kostet die Heilung — plant eure Cooldowns um die Soak-Gruppen herum.|n• {SPELL:1301118} hinterlässt einen DoT auf den verbundenen Spielern.",
	RAID_BOSS_ULATEK_DPS = "• Heroism beim ersten Venomous Heart.|n• In Phase 3 bleiben die Nahkämpfer auf der Bossplattform, und die Blightscale-Adds fallen schnell.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Wechselt bei 8-10 Stapeln Blackening Wounds — jeder Stapel senkt die maximale Gesundheit des aktiven Tanks.",
	RAID_BOSS_AVERZIAN_DPS = "• Tötet die Abyssal Voidshaper so, dass nie drei in einer Reihe überleben — ein beendeter Zauber beansprucht das Feld.|n• Danach die Shadowguard Stalwarts, danach die Voidbound Annihilators.",
	...
	RAID_BOSS_VORASIUS_TANK = "Soakt die ersten beiden {SPELL:1241836} und lasst den Debuff dann auslaufen — der Off-Tank nimmt die ungeraden Kreise für den Rest des Zyklus.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Stell ihn an ein markiertes Tor und kite von jedem Orb weg, bis er stirbt. Während {SPELL:1246175} lässt er sich gar nicht bewegen.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} ist von Anfang bis Ende schwerer Raidschaden.|n• Die andere Spitze ist der zweite Orb, der stirbt, während Dark Radiation noch auf dem Raid liegt — lasst ihn zurückhalten.",
...
merge(ns._mhLocales and ns._mhLocales.frFR, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Chaque add qui l'atteint coûte au raid de lourds dégâts et un DoT.|n• La phase 2 inflige des dégâts constants à tout le raid — répartis tes cooldowns sur toute la phase.",
	RAID_BOSS_NEKZALI_DPS = "• Brise les boucliers de {SPELL:1297630} avec des dégâts magiques, puis tue-les.|n• Tuez les Echoes of Jawae pour terminer l'intermède.|n• Ouvrez la phase 2 avec les cooldowns — il doit tomber avant d'atteindre 100 d'énergie.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• Un add qui atteint le centre, c'est de lourds dégâts DoT sur tout le raid.|n• À la fontaine de Feu, les Burning Venoms infligent des dégâts pulsés à tout le monde.",
	RAID_BOSS_VASHNIK_DPS = "• Chaque add meurt avant d'atteindre le centre — c'est tout le travail.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In lui fait subir 30% de dégâts en plus — c'est la fenêtre de burst.",
	...
	RAID_BOSS_ULATEK_TANK = "Reste à portée de mêlée tout du long — un tank prend la queue, l'autre le boss lui-même.",
	RAID_BOSS_ULATEK_HEALER = "• C'est le soak qui coûte les soins — planifie tes cooldowns autour des groupes de soak.|n• {SPELL:1301118} laisse un DoT sur les joueurs qu'il relie.",
	RAID_BOSS_ULATEK_DPS = "• Heroism sur le premier Venomous Heart.|n• En phase 3, les corps-à-corps restent sur la plateforme du boss et les adds Blightscale tombent vite.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Échangez à 8-10 stacks de Blackening Wounds — chaque stack réduit les points de vie maximum du tank actif.",
	RAID_BOSS_AVERZIAN_DPS = "• Tuez les Abyssal Voidshapers de sorte que trois ne survivent jamais en ligne — une incantation terminée s'empare de la case.|n• Ensuite les Shadowguard Stalwarts, puis les Voidbound Annihilators.",
	...
	RAID_BOSS_VORASIUS_TANK = "Absorbe les deux premiers {SPELL:1241836}, puis laisse le debuff expirer — l'off-tank prend les cercles impairs pour le reste du cycle.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Place-le près d'une porte marquée et éloigne-toi de chaque orbe jusqu'à sa mort. Pendant {SPELL:1246175} il est impossible à déplacer.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} inflige de lourds dégâts au raid du début à la fin.|n• L'autre pic, c'est le deuxième orbe qui meurt alors que Dark Radiation est encore sur le raid — demande aux dps de le retenir.",
...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Cada add que lo alcanza cuesta al raid daño fuerte más un DoT.|n• La fase 2 es daño constante a todo el raid — reparte tus cooldowns por toda la fase.",
	RAID_BOSS_NEKZALI_DPS = "• Rompe los escudos de {SPELL:1297630} con daño mágico y luego mátalos.|n• Matad a los Echoes of Jawae para terminar el intermedio.|n• Abrid la fase 2 con cooldowns — tiene que morir antes de llegar a 100 de energía.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• Un add que llega al centro es daño DoT fuerte sobre todo el raid.|n• En la fuente de Fuego los Burning Venoms pulsan daño sobre todos.",
	RAID_BOSS_VASHNIK_DPS = "• Cada add muere antes de llegar al centro — ese es todo el trabajo.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In hace que reciba un 30% más de daño — esa es la ventana de burst.",
	...
	RAID_BOSS_ULATEK_TANK = "Quedaos a distancia de cuerpo a cuerpo todo el rato — un tanque lleva la cola, el otro al jefe.",
	RAID_BOSS_ULATEK_HEALER = "• El soak es lo que cuesta las curaciones — planifica tus cooldowns en torno a los grupos de soak.|n• {SPELL:1301118} deja un DoT en los jugadores que enlaza.",
	RAID_BOSS_ULATEK_DPS = "• Heroism en el primer Venomous Heart.|n• En la fase 3 los cuerpo a cuerpo se quedan en la plataforma del jefe y los adds Blightscale caen rápido.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Cambiad a 8-10 acumulaciones de Blackening Wounds — cada una reduce la salud máxima del tanque activo.",
	RAID_BOSS_AVERZIAN_DPS = "• Matad a los Abyssal Voidshapers de modo que nunca sobrevivan tres en línea — un lanzamiento completado reclama esa casilla.|n• Luego los Shadowguard Stalwarts, después los Voidbound Annihilators.",
	...
	RAID_BOSS_VORASIUS_TANK = "Absorbe los dos primeros {SPELL:1241836} y deja que el debuff caduque — el off-tank se queda con los círculos impares el resto del ciclo.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Colócalo junto a una puerta marcada y aléjalo de cada orbe hasta que muera. Durante {SPELL:1246175} no se le puede mover.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} es daño fuerte al raid de principio a fin.|n• El otro pico es el segundo orbe muriendo mientras Dark Radiation sigue sobre el raid — pide a los dps que lo retengan.",
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	RAID_BOSS_NEKZALI_HEALER = "• Cada add que o alcança custa ao raide dano pesado mais um DoT.|n• A fase 2 é dano constante em todo o raide — distribua seus cooldowns pela fase inteira.",
	RAID_BOSS_NEKZALI_DPS = "• Quebre os escudos de {SPELL:1297630} com dano mágico e depois mate-os.|n• Matem os Echoes of Jawae para encerrar o intervalo.|n• Abram a fase 2 com cooldowns — ele precisa cair antes de chegar a 100 de energia.",
	...
	RAID_BOSS_LOSTEXPLORERS_STEPS = "• Interrompe {SPELL:1286921}.|n• O chão é a luta: desvia de {SPELL:1291759}, {SPELL:1291933} e {SPELL:1292104}.|n• {SPELL:1290711}: as nossas duas fontes contradizem-se — afastar ou juntar — segue a indicação do teu líder.|n• Dá Disgusting Fish aos Tortollans possuídos para quebrar a possessão.|n• Mor'zahi: interrompe Final Ascension sempre que puderes — desde o hotfix de 10 de setembro, isso reinicia o aumento do dano dele.",
	...
	RAID_BOSS_VASHNIK_HEALER = "• Um add que chega ao centro é dano DoT pesado em todo o raide.|n• Na fonte de Fogo os Burning Venoms pulsam dano em todos.",
	RAID_BOSS_VASHNIK_DPS = "• Cada add morre antes de chegar ao centro — é esse o trabalho todo.",
	...
	RAID_BOSS_SSZORAK_DPS = "• Dig In faz com que ele receba 30% mais dano — essa é a janela de burst.",
	...
	RAID_BOSS_ULATEK_TANK = "Fiquem em alcance corpo a corpo o tempo todo — um tanque segura a cauda, o outro o chefe.",
	RAID_BOSS_ULATEK_HEALER = "• O soak é o que custa a cura — planeje seus cooldowns em torno dos grupos de soak.|n• {SPELL:1301118} deixa um DoT nos jogadores que ele liga.",
	RAID_BOSS_ULATEK_DPS = "• Heroism no primeiro Venomous Heart.|n• Na fase 3 os corpo a corpo ficam na plataforma do chefe e os adds Blightscale caem rápido.",
	...
	RAID_BOSS_AVERZIAN_TANK = "Troquem com 8-10 acúmulos de Blackening Wounds — cada um reduz a vida máxima do tanque ativo.",
	RAID_BOSS_AVERZIAN_DPS = "• Matem os Abyssal Voidshapers de modo que nunca sobrevivam três em linha — uma conjuração concluída toma aquela casa.|n• Depois os Shadowguard Stalwarts, então os Voidbound Annihilators.",
	...
	RAID_BOSS_VORASIUS_TANK = "Absorva os dois primeiros {SPELL:1241836} e deixe o debuff expirar — o off-tank pega os círculos ímpares no resto do ciclo.",
	...
	RAID_BOSS_SALHADAAR_TANK = "Posicione-o perto de um portão marcado e afaste-se de cada orbe até ela morrer. Durante {SPELL:1246175} ele não pode ser movido.",
	RAID_BOSS_SALHADAAR_HEALER = "• {SPELL:1246175} é dano pesado no raide do início ao fim.|n• O outro pico é a segunda orbe morrendo enquanto Dark Radiation ainda está no raide — peça aos dps para segurá-la.",
