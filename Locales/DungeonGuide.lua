...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	DGN_WIN_SHARE = "Share",
	DGN_WIN_ROUTE = "Route",
	DGN_WIN_ROUTE_LIVE = "Your client sees this one as active right now.",
	DGN_WIN_ROUTE_NOT_LIVE = "Your client does not list this as active yet — the arrow points at the entrance regardless.",
...
merge(ns._mhLocales and ns._mhLocales.itIT, {
	...
	DGN_WIN_ROUTE_LIVE = "Il tuo client lo vede attivo in questo momento.",
	DGN_WIN_ROUTE_NOT_LIVE = "Il tuo client non lo elenca ancora come attivo — la freccia punta comunque all’ingresso.",
...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	DGN_WIN_SHARE = "Deel",
	DGN_WIN_ROUTE = "Route",
	DGN_WIN_ROUTE_LIVE = "Je client ziet deze nu als actief.",
	DGN_WIN_ROUTE_NOT_LIVE = "Je client meldt deze nog niet als actief — de pijl wijst hoe dan ook naar de ingang.",
	DGN_WIN_BOSS_PROMPT = "Boss gepuld — bossgids openen?",
	FOLLOWER_BOSSHINT_TITLE = "Follower dungeon",
	FOLLOWER_BOSSHINT_BODY = "Boss-tips kunnen hier niet vanzelf verschijnen — het spel verbergt bossnamen in follower dungeons.",
	FOLLOWER_BOSSHINT_CLICK = "Klik om de boss-gids te openen  ·  of typ /mh bosswin",
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	DGN_WIN_ROUTE = "Route",
	DGN_WIN_ROUTE_LIVE = "Dein Client sieht dies gerade als aktiv an.",
	DGN_WIN_ROUTE_NOT_LIVE = "Dein Client führt dies noch nicht als aktiv — der Pfeil zeigt trotzdem zum Eingang.",
...
merge(ns._mhLocales and ns._mhLocales.frFR, {
	...
	DGN_WIN_ROUTE_LIVE = "Votre client le voit actuellement comme actif.",
	DGN_WIN_ROUTE_NOT_LIVE = "Votre client ne le liste pas encore comme actif — la flèche pointe quand même vers l’entrée.",
...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	DGN_WIN_ROUTE = "Ruta",
	DGN_WIN_ROUTE_LIVE = "Tu cliente lo ve como activo ahora mismo.",
	DGN_WIN_ROUTE_NOT_LIVE = "Tu cliente aún no lo lista como activo — la flecha apunta igualmente a la entrada.",
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	DGN_WIN_ROUTE = "Rota",
	DGN_WIN_ROUTE_LIVE = "Seu cliente vê isto como ativo agora.",
	DGN_WIN_ROUTE_NOT_LIVE = "Seu cliente ainda não lista isto como ativo — a seta aponta para a entrada mesmo assim.",
