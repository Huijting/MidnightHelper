...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffWhat it is:|r a 12.1 area on the Coiled Isle with its own map, and a second map underneath it, the Underbelly. It is open now — there is no season gate on it.|n• |cffffffffHow you get in:|r a chain of three quests — |cffffffffInto the Vaults of Atal'Utek|r, then |cffffffffVaults of Atal'Utek: One Coin Too Many|r, then |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Everything below sits behind them, so do those first.|n• |cffffffffCorrosive Coin|r is the zone's currency. The game's own words: “Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token.” Your balance is the number above this article.|n• |cffffffffCorrosive Soul is not that.|r It is not a currency at all but an |cffffffffitem|r in your bags, and it is what the Corrosive Codex asks you to offer. Guides swap the two names constantly; the game never does. If something tells you to spend Corrosive Coins at the Codex, that is the mix-up.|n• |cffffffffWhere the coins go:|r |cffffffffEr’inye|r, at |cffffffff51.10, 62.76|r on the Vaults map, beside the Altar. Talk to him and he corrodes your spirit in exchange for coin — that is what feeds the tree. His window names the price; this page does not, because nobody has read it yet.|n• |cffffffffThe Altar of Corrosion|r is the node tree the last quest of the chain opens. What its nodes hand out has not been measured, so this page does not tell you — read the tooltips in that window itself.|n• |cffffffff“The Honored Dead” — twelve memorials|r on the Vaults map, one achievement, and the clearest thing here to just go and do. In one walking order, from the top of the map downwards:|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (under the bridge) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffThe Underbelly|r is the map below, entered at |cffffffff47.30, 11.20|r on the Vaults map. One rare lives down there, |cffffffffSzarith the Fanged|r at 38.40, 17.69, and the Underbelly carries its own achievement, |cffffffffSoft Underbelly|r.|n• |cffffffffThree rare elites on the main map|r — Congealed Malice, Khu'tulak and Susarikk — make up a third, |cffffffffOppose the Foes|r. |cffffffffNobody knows where they stand|r, us included, so keep an eye out for them while you walk the memorial route rather than setting out to hunt them.",
})
...
merge(ns._mhLocales and ns._mhLocales.itIT, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffCos'è:|r una zona della 12.1 sulla Coiled Isle con una mappa propria, e sotto di essa una seconda mappa, la Underbelly. È già aperta — nessun blocco stagionale.|n• |cffffffffCome si entra:|r una catena di tre missioni — |cffffffffInto the Vaults of Atal'Utek|r, poi |cffffffffVaults of Atal'Utek: One Coin Too Many|r, poi |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Tutto quello che segue sta dietro a queste, quindi falle per prime.|n• |cffffffffCorrosive Coin|r è la currency della zona. Parole del gioco: “Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token.” Il tuo saldo è il numero qui sopra.|n• |cffffffffCorrosive Soul non è quella.|r Non è affatto una currency ma un |cffffffffoggetto|r nelle tue borse, ed è ciò che il Corrosive Codex ti chiede di offrire. Le guide scambiano di continuo i due nomi; il gioco mai. Se qualcosa ti dice di spendere Corrosive Coins al Codex, è quello lo scambio.|n• |cffffffffDove finiscono le monete:|r |cffffffffEr’inye|r, a |cffffffff51.10, 62.76|r sulla mappa delle Vaults, accanto all’altare. Parlagli e corrode il tuo spirito in cambio di monete — è questo che alimenta l’albero. La sua finestra dice il prezzo; questa pagina no, perché nessuno l’ha letta.|n• |cffffffffL'Altar of Corrosion|r è l'albero di nodi che apre l'ultima missione della catena. Cosa diano davvero quei nodi non è stato misurato, quindi questa pagina non te lo dice — leggi i tooltip in quella finestra.|n• |cffffffff“The Honored Dead” — dodici memoriali|r sulla mappa delle Vaults, un obiettivo, ed è la cosa più chiara da andare a fare qui. In un unico percorso, dall'alto della mappa verso il basso:|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (sotto il ponte) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffLa Underbelly|r è la mappa sottostante, si entra a |cffffffff47.30, 11.20|r sulla mappa delle Vaults. Là sotto vive un raro, |cffffffffSzarith the Fanged|r a 38.40, 17.69, e la Underbelly ha un obiettivo tutto suo, |cffffffffSoft Underbelly|r.|n• |cffffffffTre rari elite sulla mappa principale|r — Congealed Malice, Khu'tulak e Susarikk — formano un terzo: |cffffffffOppose the Foes|r. |cffffffffNessuno sa dove si trovino|r, noi compresi, quindi tienili d'occhio mentre percorri il giro dei memoriali invece di partire a cercarli.",
})
...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffWat het is:|r een stuk 12.1-content op de Coiled Isle met een eigen kaart, en daaronder nóg een kaart: de Underbelly. Het staat nu al open — er zit geen seizoenspoort op.|n• |cffffffffHoe je binnenkomt:|r een keten van drie quests — |cffffffffInto the Vaults of Atal'Utek|r, dan |cffffffffVaults of Atal'Utek: One Coin Too Many|r, dan |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Alles hieronder zit erachter, dus doe die eerst.|n• |cffffffffCorrosive Coin|r is de currency van de zone. In de woorden van het spel zelf: “Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token.” Je eigen saldo is het getal hierboven.|n• |cffffffffCorrosive Soul is dat niet.|r Het is helemaal geen currency maar een |cffffffffitem|r in je tassen, en het is wat de Corrosive Codex als offer van je vraagt. Gidsen halen de twee namen voortdurend door elkaar; het spel nooit. Zegt iets dat je Corrosive Coins bij de Codex moet uitgeven, dan is dat precies die verwisseling.|n• |cffffffffWaar de munten heen gaan:|r |cffffffffEr’inye|r, op |cffffffff51.10, 62.76|r op de Vaults-kaart, naast de Altar. Praat met hem en hij corrodeert je geest in ruil voor munten — dat is wat de boom voedt. Zijn venster noemt de prijs; deze pagina niet, want niemand heeft hem gelezen.|n• |cffffffffThe Altar of Corrosion|r is de boom met nodes die de laatste quest van de keten opent. Wat die nodes uitgeven is nooit gemeten, dus deze pagina zegt het niet — lees de tooltips in dat venster zelf.|n• |cffffffff“The Honored Dead” — twaalf gedenktekens|r op de Vaults-kaart, één achievement, en verreweg het duidelijkste om hier gewoon te gaan dóen. In één looproute, van boven op de kaart naar beneden:|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (onder de brug) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffDe Underbelly|r is de kaart eronder, met de ingang op |cffffffff47.30, 11.20|r op de Vaults-kaart. Daar woont één rare, |cffffffffSzarith the Fanged|r op 38.40, 17.69, en de Underbelly heeft een eigen achievement: |cffffffffSoft Underbelly|r.|n• |cffffffffDrie rare elites op de hoofdkaart|r — Congealed Malice, Khu'tulak en Susarikk — vormen een derde: |cffffffffOppose the Foes|r. |cffffffffNiemand weet waar ze staan|r, wij ook niet, dus houd ze in de gaten terwijl je de gedenktekenroute loopt in plaats van er gericht op uit te trekken.",
})
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffWas es ist:|r ein 12.1-Gebiet auf der Coiled Isle mit eigener Karte, und darunter eine zweite Karte, die Underbelly. Es ist bereits offen — kein Saisontor davor.|n• |cffffffffWie du hineinkommst:|r eine Kette aus drei Quests — |cffffffffInto the Vaults of Atal'Utek|r, dann |cffffffffVaults of Atal'Utek: One Coin Too Many|r, dann |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Alles Weitere liegt dahinter, also mach die zuerst.|n• |cffffffffCorrosive Coin|r ist die Währung der Zone. Mit den Worten des Spiels: „Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token.“ Dein Bestand ist die Zahl über diesem Artikel.|n• |cffffffffCorrosive Soul ist das nicht.|r Es ist überhaupt keine Währung, sondern ein |cffffffffGegenstand|r in deinen Taschen, und genau danach fragt der Corrosive Codex. Guides vertauschen die beiden Namen ständig; das Spiel nie. Wenn dir etwas sagt, du sollst Corrosive Coins am Codex ausgeben, ist das die Verwechslung.|n• |cffffffffWohin die Münzen gehen:|r |cffffffffEr’inye|r, bei |cffffffff51.10, 62.76|r auf der Vaults-Karte, neben dem Altar. Sprich mit ihm, und er zersetzt deinen Geist gegen Münzen — das ist es, was den Baum speist. Sein Fenster nennt den Preis; diese Seite nicht, denn niemand hat ihn gelesen.|n• |cffffffffDer Altar of Corrosion|r ist der Knotenbaum, den die letzte Quest der Kette öffnet. Was seine Knoten ausgeben, wurde nie gemessen, deshalb sagt es diese Seite nicht — lies die Tooltips in diesem Fenster selbst.|n• |cffffffff„The Honored Dead“ — zwölf Gedenkstätten|r auf der Vaults-Karte, ein Erfolg, und das Klarste, was man hier einfach tun kann. In einer Laufreihenfolge, von oben auf der Karte nach unten:|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (unter der Brücke) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffDie Underbelly|r ist die Karte darunter, Eingang bei |cffffffff47.30, 11.20|r auf der Vaults-Karte. Dort unten lebt ein Rarer, |cffffffffSzarith the Fanged|r bei 38.40, 17.69, und die Underbelly hat einen eigenen Erfolg: |cffffffffSoft Underbelly|r.|n• |cffffffffDrei seltene Elite-Gegner auf der Hauptkarte|r — Congealed Malice, Khu'tulak und Susarikk — bilden einen dritten: |cffffffffOppose the Foes|r. |cffffffffNiemand weiß, wo sie stehen|r, wir eingeschlossen, also halte beim Ablaufen der Gedenkstätten die Augen offen, statt gezielt auf die Jagd zu gehen.",
})
...
merge(ns._mhLocales and ns._mhLocales.frFR, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffCe que c'est :|r une zone de la 12.1 sur la Coiled Isle avec sa propre carte, et en dessous une seconde carte, l'Underbelly. C'est déjà ouvert — aucune barrière de saison.|n• |cffffffffComment y entrer :|r une chaîne de trois quêtes — |cffffffffInto the Vaults of Atal'Utek|r, puis |cffffffffVaults of Atal'Utek: One Coin Too Many|r, puis |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Tout le reste se trouve derrière, alors fais-les d'abord.|n• |cffffffffCorrosive Coin|r est la monnaie de la zone. Selon les mots du jeu : « Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token. » Ton solde est le nombre affiché au-dessus.|n• |cffffffffCorrosive Soul, ce n'est pas ça.|r Ce n'est pas du tout une monnaie mais un |cffffffffobjet|r dans tes sacs, et c'est ce que le Corrosive Codex te demande d'offrir. Les guides intervertissent sans cesse les deux noms ; le jeu jamais. Si quelque chose te dit de dépenser des Corrosive Coins au Codex, c'est cette confusion-là.|n• |cffffffffOù vont les pièces :|r |cffffffffEr’inye|r, en |cffffffff51.10, 62.76|r sur la carte des Vaults, à côté de l’autel. Parle-lui et il corrode ton esprit contre des pièces — c’est ce qui alimente l’arbre. Sa fenêtre annonce le prix ; pas cette page, car personne ne l’a lu.|n• |cffffffffL'Altar of Corrosion|r est l'arbre de nœuds qu'ouvre la dernière quête de la chaîne. Ce que ses nœuds donnent n'a jamais été mesuré, donc cette page ne le dit pas — lis les infobulles dans cette fenêtre.|n• |cffffffff« The Honored Dead » — douze mémoriaux|r sur la carte des Vaults, un haut fait, et la chose la plus claire à aller faire ici. Dans un seul ordre de marche, du haut de la carte vers le bas :|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (sous le pont) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffL'Underbelly|r est la carte du dessous, entrée à |cffffffff47.30, 11.20|r sur la carte des Vaults. Un rare y vit, |cffffffffSzarith the Fanged|r à 38.40, 17.69, et l'Underbelly a son propre haut fait, |cffffffffSoft Underbelly|r.|n• |cffffffffTrois élites rares sur la carte principale|r — Congealed Malice, Khu'tulak et Susarikk — forment un troisième : |cffffffffOppose the Foes|r. |cffffffffPersonne ne sait où ils se tiennent|r, nous compris, alors garde-les à l'œil pendant ta tournée des mémoriaux au lieu de partir les chasser.",
})
...
merge(ns._mhLocales and ns._mhLocales.esES, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffQué es:|r una zona de la 12.1 en la Coiled Isle con mapa propio, y debajo un segundo mapa, la Underbelly. Ya está abierta — no hay puerta de temporada.|n• |cffffffffCómo entrar:|r una cadena de tres misiones — |cffffffffInto the Vaults of Atal'Utek|r, luego |cffffffffVaults of Atal'Utek: One Coin Too Many|r, luego |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Todo lo demás está detrás de ellas, así que hazlas primero.|n• |cffffffffCorrosive Coin|r es la moneda de la zona. En palabras del propio juego: “Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token.” Tu saldo es el número que aparece arriba.|n• |cffffffffCorrosive Soul no es eso.|r No es una moneda en absoluto, sino un |cffffffffobjeto|r en tus bolsas, y es lo que el Corrosive Codex te pide ofrecer. Las guías intercambian los dos nombres continuamente; el juego nunca. Si algo te dice que gastes Corrosive Coins en el Codex, esa es la confusión.|n• |cffffffffAdónde van las monedas:|r |cffffffffEr’inye|r, en |cffffffff51.10, 62.76|r del mapa de las Vaults, junto al altar. Habla con él y corroe tu espíritu a cambio de monedas — eso es lo que alimenta el árbol. Su ventana dice el precio; esta página no, porque nadie lo ha leído.|n• |cffffffffEl Altar of Corrosion|r es el árbol de nodos que abre la última misión de la cadena. Lo que reparten sus nodos no se ha medido, así que esta página no te lo dice — lee las descripciones emergentes en esa ventana.|n• |cffffffff“The Honored Dead” — doce memoriales|r en el mapa de las Vaults, un logro, y lo más claro que puedes ir a hacer aquí. En un solo orden de recorrido, de arriba del mapa hacia abajo:|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (bajo el puente) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffLa Underbelly|r es el mapa de abajo, se entra en |cffffffff47.30, 11.20|r del mapa de las Vaults. Allí vive un raro, |cffffffffSzarith the Fanged|r en 38.40, 17.69, y la Underbelly tiene un logro propio: |cffffffffSoft Underbelly|r.|n• |cffffffffTres élites raros en el mapa principal|r — Congealed Malice, Khu'tulak y Susarikk — forman un tercero: |cffffffffOppose the Foes|r. |cffffffffNadie sabe dónde están|r, nosotros tampoco, así que vigílalos mientras recorres los memoriales en lugar de salir a cazarlos.",
})
...
merge(ns._mhLocales and ns._mhLocales.ptBR, {
	...
	CODEX_ATALUTEK_BODY = "• |cffffffffO que é:|r uma área da 12.1 na Coiled Isle com mapa próprio, e por baixo um segundo mapa, a Underbelly. Já está aberta — não há porta de temporada.|n• |cffffffffComo entrar:|r uma cadeia de três missões — |cffffffffInto the Vaults of Atal'Utek|r, depois |cffffffffVaults of Atal'Utek: One Coin Too Many|r, depois |cffffffffVaults of Atal'Utek: The Altar of Corrosion|r. Tudo o resto está atrás delas, por isso faz essas primeiro.|n• |cffffffffCorrosive Coin|r é a moeda da zona. Nas palavras do próprio jogo: “Spirits of the Amani within the Vaults of Atal'Utek deal exclusively in this phantasmal token.” O teu saldo é o número acima deste artigo.|n• |cffffffffCorrosive Soul não é isso.|r Não é moeda nenhuma, mas um |cffffffffitem|r nas tuas bolsas, e é o que o Corrosive Codex te pede para oferecer. Os guias trocam os dois nomes constantemente; o jogo nunca. Se algo te disser para gastar Corrosive Coins no Codex, é essa a troca.|n• |cffffffffPara onde vão as moedas:|r |cffffffffEr’inye|r, em |cffffffff51.10, 62.76|r no mapa das Vaults, ao lado do altar. Fala com ele e ele corrói o teu espírito em troca de moedas — é isso que alimenta a árvore. A janela dele diz o preço; esta página não, porque ninguém o leu.|n• |cffffffffO Altar of Corrosion|r é a árvore de nós que a última missão da cadeia abre. O que os seus nós dão nunca foi medido, por isso esta página não o diz — lê as descrições na própria janela.|n• |cffffffff“The Honored Dead” — doze memoriais|r no mapa das Vaults, uma proeza, e a coisa mais clara para ires fazer aqui. Numa só ordem de percurso, do topo do mapa para baixo:|n|cffffffffTo a sister|r 46.79, 7.51 · |cffffffffTo a shield-bearer|r 56.49, 22.88 · |cffffffffTo a father|r 47.22, 28.77 · |cffffffffTo a stranger|r 42.57, 33.18 (debaixo da ponte) · |cffffffffTo a captain|r 52.91, 33.90 · |cffffffffTo a dream|r 55.62, 40.60 · |cffffffffTo sons|r 42.91, 41.23 · |cffffffffTo a lover|r 52.21, 45.12 · |cffffffffTo Comrades|r 38.50, 47.66 · |cffffffffTo parents|r 55.31, 48.45 · |cffffffffTo a daughter|r 49.50, 56.59 · |cffffffffTo Failure|r 45.81, 61.79|n• |cffffffffA Underbelly|r é o mapa de baixo, com entrada em |cffffffff47.30, 11.20|r no mapa das Vaults. Lá em baixo vive um raro, |cffffffffSzarith the Fanged|r em 38.40, 17.69, e a Underbelly tem uma proeza própria: |cffffffffSoft Underbelly|r.|n• |cffffffffTrês elites raros no mapa principal|r — Congealed Malice, Khu'tulak e Susarikk — formam uma terceira: |cffffffffOppose the Foes|r. |cffffffffNinguém sabe onde estão|r, nós incluídos, por isso fica atento a eles enquanto percorres os memoriais em vez de saíres à caça deles.",
})
