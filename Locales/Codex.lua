...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	CODEX_PROFRESET_BODY = "• Patch 12.1 laat je je Midnight-specialisatiekeuzes terugdraaien — één keer per beroep.|n• |cffffffffBij wie:|r Theremis, in de Bazaar van Silvermoon naast de crafting orders. Hij biedt per beroep een aparte regel, dus je kunt Blacksmithing resetten en Enchanting precies laten zoals hij is.|n• |cffffffffWat je terugkrijgt:|r elk Knowledge Point dat je in de Midnight-bomen van dat beroep hebt uitgegeven, vrij om opnieuw te verdelen.|n• |cffffffffWat het kost:|r de waarschuwing van het spel zelf luidt “You will lose all associated recipes”. Het belooft ze niet terug.|n• |cffffffffHet is één keer.|r De bevestiging zegt ONCE in hoofdletters, en dat is per beroep — er is geen tweede poging als het nieuwe pad tegenvalt.|n• Bepaal dus |cffffffffvooraf|r waar de punten heen gaan. De Professions-pagina noemt de boom die je moet vullen en precies welke node.|n• Komen je oude recepten terug als je identiek herbesteedt? Het spel zegt dat nergens. Ga ervan uit dat ze weg zijn.",
})
...
merge(ns._mhLocales and ns._mhLocales.deDE, {
	...
	CODEX_PROFRESET_BODY = "• Patch 12.1 lässt dich deine Midnight-Spezialisierungen zurücksetzen — einmal pro Beruf.|n• |cffffffffBei wem:|r Theremis, im Basar von Silbermond neben den Handwerksaufträgen. Er bietet pro Beruf eine eigene Zeile, du kannst also Schmiedekunst zurücksetzen und Verzauberkunst unangetastet lassen.|n• |cffffffffWas du zurückbekommst:|r jeden Wissenspunkt, den du in den Midnight-Bäumen dieses Berufs ausgegeben hast, frei neu verteilbar.|n• |cffffffffWas es kostet:|r die Warnung des Spiels selbst lautet „You will lose all associated recipes“. Sie verspricht sie nicht zurück.|n• |cffffffffEs ist einmalig.|r Die Bestätigung sagt ONCE in Großbuchstaben, und zwar pro Beruf — einen zweiten Versuch gibt es nicht, wenn der neue Weg enttäuscht.|n• Entscheide also |cffffffffvorher|r, wohin die Punkte gehen. Die Berufe-Seite nennt den zu füllenden Baum und den genauen Knoten.|n• Kommen die alten Rezepte zurück, wenn du identisch neu verteilst? Das Spiel sagt es nirgends. Geh davon aus, dass sie weg sind.",
})
...
merge(ns._mhLocales and ns._mhLocales.frFR, {
	...
	CODEX_PROFRESET_BODY = "• Le patch 12.1 permet d’annuler tes choix de spécialisation Midnight — une fois par métier.|n• |cffffffffChez qui :|r Theremis, au Bazar de Lune-d’argent, à côté des commandes d’artisanat. Il propose une ligne par métier : tu peux réinitialiser le Forgeage et laisser l’Enchantement intact.|n• |cffffffffCe que tu récupères :|r chaque point de Connaissance dépensé dans les arbres Midnight de ce métier, libre de le replacer.|n• |cffffffffCe que ça coûte :|r l’avertissement du jeu lui-même dit « You will lose all associated recipes ». Il ne promet pas de te les rendre.|n• |cffffffffC’est une seule fois.|r La confirmation écrit ONCE en majuscules, et c’est par métier — pas de deuxième essai si la nouvelle voie te déçoit.|n• Décide donc |cffffffffavant|r de confirmer. La page Métiers indique l’arbre à remplir et le nœud exact.|n• Les anciennes recettes reviennent-elles si tu redépenses à l’identique ? Le jeu ne le dit nulle part. Considère-les comme perdues.",
})
