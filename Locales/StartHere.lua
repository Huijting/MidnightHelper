...
merge(ns._mhLocales and ns._mhLocales.enUS, {
	...
	TOUR_CM_ROOMS_TITLE_LOOK = "The rooms",
	TOUR_CM_ROOMS_BODY_LOOK = "This is your navigation: four rooms. Click one to see all its screens as cards; click it again any time to get back to them.",
...
merge(ns._mhLocales and ns._mhLocales.nlNL, {
	...
	TOUR_CM_ROOMS_TITLE_LOOK = "De kamers",
	TOUR_CM_ROOMS_BODY_LOOK = "Dit is je navigatie: vier kamers. Klik er een aan om al zijn schermen als tegels te zien; klik er later weer op om terug te gaan naar de tegels.",
